...
def calculates_results_stats(results_dic):
        ...
        numberOfImages = len(results_dic)
        ...
        results_stats_dic = dict()
        keys = ["n_images","n_dogs_img","n_notdogs_img","n_correct_dogs","n_correct_notdogs","n_correct_breed","pct_correct_dogs","pct_correct_breed","pct_correct_notdogs"]
