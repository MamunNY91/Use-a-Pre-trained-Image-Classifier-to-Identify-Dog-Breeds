...
def print_results(results_dic, results_stats_dic, model, 
                  ...
                  """
                  numberOfImg = len(results_dic)
                  numberOfDogImg = results_stats_dic["n_dogs_img"]
                  numberOfNotDogImg = results_stats_dic["n_notdogs_img"]
                  pctOfCorrectDog = results_stats_dic["pct_correct_dogs"]
                  pctOfCorrectBreed = results_stats_dic["pct_correct_breed"]
                  pctOfCorrectNotDog = results_stats_dic["pct_correct_notdogs"]
